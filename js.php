...
<body>
	...
	<div class="wrapper" id="outPopUp">
		<form action="js.php" method="POST" class="center" enctype="multipart/form-data">
		...
		<div style="margin-top: 20">
			...
			<br/><div class="popup" onclick="myFunction()"><center><input type="submit" class="btn btn-primary"name="submit" value="Register"><span class="popuptext" id="myPopup"><?php echo $donotmtach; ?></center><center><?php echo $registered; ?></center><center><?php echo $pleasefill; ?></center><center><?php echo $unsuccessfull; ?></center><center><?php echo $usernamebetw; ?></center><center><?php echo $passwordlen; ?></center><center><?php 
			echo $alreadyregis; ?> </center><center><?php 
			echo $wrong_file; ?> </center></span></center>
		</div>
		</form>
